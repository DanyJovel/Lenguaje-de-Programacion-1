...
int main(int argc, char* argv[]) {	
    ...
    /*
		...
		1 - Actualmente con el password admin puede ingresar al sistema. Cree un segundo password para poder ingresar al sistema. 
		Siempre debe poder ingresar con el password admin y con el nuevo password.
	...
	*/						
	...
	while (acceso == false) {		
		...
		//Aqui se crea el nuevo password
		else{
			if (password == "danyjovel") {
			acceso = true;
			}
		}						
	}
	...
	while(ingresarMasProductos == true) {
		...
		//Aqui se agrega la opcion 5 en el menu
		cout << "5 - Cheescake ........... L 40.00" << endl;
		cout << "---------------------------------------------------------------" << endl;
		cout << "0 - Salir" << endl;
		cout << "---------------------------------------------------------------" << endl;
		cout << endl;
		...
		switch(opcion) {
			...
			case 5:
				...
				productosComprados = productosComprados + "Cheescake ........... L 40.00\n";
				numeroArticulos++;
				break;				
			default:
